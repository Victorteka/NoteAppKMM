package com.victorteka.noteappkmm.android.note_detail
...
fun NoteDetailScreen(
    ...
    val hasStateBeenSaved by viewModel.hasNoteBeenSaved.collectAsState()

    LaunchedEffect(key1 = hasStateBeenSaved) {
